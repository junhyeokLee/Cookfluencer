...
mixin _$VideoData {
  ...
  RecipeData? get recipe => throw _privateConstructorUsedError; // 하나의 레시피 추가
...
abstract class $VideoDataCopyWith<$Res> {
  ...
  $RecipeDataCopyWith<$Res>? get recipe;
}
...
class _$VideoDataCopyWithImpl<$Res, $Val extends VideoData>
  ...
  $RecipeDataCopyWith<$Res>? get recipe {
    ...
    return $RecipeDataCopyWith<$Res>(_value.recipe!, (value) {
...
// 하나의 레시피 추가
  ...
  @override
  String toString() {
    return 'VideoData(id: $id, channelId: $channelId, channelName: $channelName, description: $description, thumbnailUrl: $thumbnailUrl, title: $title, uploadDate: $uploadDate, videoId: $videoId, videoUrl: $videoUrl, viewCount: $viewCount, section: $section, recipe: $recipe, isLiked: $isLiked)';
  }
...
abstract class _VideoData implements VideoData {
  ...
  String get section;
  @override
  RecipeData? get recipe; // 하나의 레시피 추가
  @override
  bool get isLiked;
