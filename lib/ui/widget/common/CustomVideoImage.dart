...
class CustomVideoImage extends StatelessWidget {
  ...
  final iconBottomPadding; // 아이콘과 이미지 사이 간격
  final iconRightPadding; // 아이콘과 이미지 사이 간격
  ...
  const CustomVideoImage({
    ...
    this.iconBottomPadding = 8.0, // 아이콘과 이미지 사이 간격
    this.iconRightPadding = 8.0, // 아이콘과 이미지 사이 간격
  });
