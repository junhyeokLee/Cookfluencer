...
import 'package:cookfluencer/ui/widget/common/RecentChannelItem.dart';
...
import '../../screen/RecentChannelScreen.dart';
import '../../screen/RecentVideoScreen.dart';
import '../common/VideoItem.dart';

class RecentChannel extends HookConsumerWidget {
  const RecentChannel({
    super.key,
    required this.recentChannelListAsyncValue,
  });

  final List<ChannelData> recentChannelListAsyncValue;
      ...
      children: [
          ...
          child: InkWell(
            onTap: () {
              Navigator.of(context).push(
                CupertinoPageRoute(
                  builder: (context) => RecentChannelScreen(),
                ),
              );
            },
            ...
            child: Row(
              ...
              children: [
                Text('새로운 채널', style: Theme.of(context).textTheme.titleLarge),
                Row(
                  children: [
                    IconButton(
        ...
        SizedBox(
          ...
          child: GridView.builder(
            ...
            itemCount: recentChannelListAsyncValue.length,
            padding: const EdgeInsets.symmetric(horizontal: 16),
            itemBuilder: (context, index) {
              var channel = recentChannelListAsyncValue[index];
              return InkWell(
                onTap: () {
                  Navigator.of(context).push(
                    CupertinoPageRoute(
