          ...
          children: [
            CarouselSlider(
              ...
              items: recommendVideoListAsyncValue.asMap().entries.map((entry) {
                ...
                int viewCount = int.tryParse(video.viewCount.toString()) ?? 0; // 숫자로 변환
                    ...
                    child: Column(
                      ...
                      children: [
                        CustomVideoImage(
                          ...
                          size: 0.65.sw,
                          fit: BoxFit.cover,
                          icon: video.recipe != null && video.recipe!.video_id.isNotEmpty
                              ? Image.asset(Assets.recipe_ai, width: 28.w, height: 28.h) // 활성화된 경우 아이콘
                              : Image.asset(Assets.recipe_ai, width: 0, height: 0), // 비활성화된 경우 빈 아이콘 (0 크기)// 플레이 아이콘
                        ),
