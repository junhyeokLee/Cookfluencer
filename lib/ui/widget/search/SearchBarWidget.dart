...
class SearchBarWidget extends HookConsumerWidget {
  const SearchBarWidget({
    ...
    this.focusNode, // FocusNode를 선택적으로 받음
    this.onFocusChange, // 포커스 상태 변경 콜백을 선택적으로 받음
  ...
  final FocusNode? focusNode; // 선택적 FocusNode
  final ValueChanged<bool>? onFocusChange; // 선택적 포커스 상태 변경 콜백
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // 포커스 상태를 감지할 리스너 추가 (있을 경우에만)
    focusNode?.addListener(() {
      onFocusChange?.call(focusNode!.hasFocus); // 포커스 상태 변경 콜백 호출 (있을 경우에만)
    });
            ...
            children: [
              ...
              Expanded(
                child: Stack(
                  ...
                  children: [
                    Padding(
                      padding: EdgeInsets.only(left: showBackButton ? 0 : 24.0),
                      // 아이콘 유무에 따라 패딩 조정
                        ...
                        child: Padding(
                          ...
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                              ...
                              contentPadding: EdgeInsets.symmetric(vertical: 24.0, horizontal: 0.0), // 여기에 패딩 추가
                            ),
                            onTap: onSearchTap,
                            onChanged: (value) {
